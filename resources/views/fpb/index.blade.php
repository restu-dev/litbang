 ...
 @section('content')
                         ...
                         <div class="row justify-content-start">
                             ...
                             <div class="col-3">
                                 <div class="input-group">
                                     ...
                                     <input type="text" class="form-control float-right" id="tgl_fpb">
                                 </div>
                             </div>
             ...
             <div class="col-lg-12">
                 <div class="card">
                     ...
                     <div class="card-header">
                         <div class="btn-group">
                             <a href="/input-fpb" class="btn btn-info btn-sm">
                                 <i class="fa fa-add"></i> Input FPB</button>
                             </a>
     ...
     {{-- modal add edit --}}
     <div class="modal fade" id="modal_cetak">
         <div class="modal-dialog modal-xl">
             <div class="modal-content">

                 <div class="modal-header">
                     <h4 class="modal-title" id="judul_surat">Default Modal</h4>
                 </div>

                 <iframe id="view_cetak" src="" frameborder="0" height="400px"></iframe>
     ...
     <script>
         ...
         $(function() {
             ...
             $(document).on("click", ".cetak_fpb", function(e) {
                ...
                $('#view_cetak').attr('src', 'view-cetak-fpb?data='+surat);
