...
class MasterBidangController extends Controller
{
    ...
    public function loadTabelMasterBidang()
    {
        ...
        for($i=0;$i<count($data);$i++){
            ...
            $edit="";
            if($yt_edit=="Y"){
                $edit = "<button data-id='$id' data-nama='$nama' data-warna='$warna' data-toggle='tooltip' data-placement='top' title='Edit' type='button' class='btn btn-info btn-sm edit_master'>
