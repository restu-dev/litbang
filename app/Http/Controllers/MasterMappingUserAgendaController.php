...
class MasterMappingUserAgendaController extends Controller
{
    ...
    public function loadTabelMasterMappingUserAgenda()
    {
        ...
        for ($i = 0; $i < count($data); $i++) {
            ...
            $edit="";
            if($yt_edit=="Y"){
                $edit = "<button data-id='$id' data-level='$id_user_level' data-jenis='$jenis' data-toggle='tooltip' data-placement='top' title='Edit' type='button' class='btn btn-info btn-sm edit_master'>
